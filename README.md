...
* それでも動かない場合  
コピーしているURLが間違っているかもしれません。  
X(旧 twitter)の投稿だとURLが勝手に短縮されてしまっていて、そのままコピーしても動かないみたいです。  
このメモに書いているURLをコピーして挑戦してください。具体的には  
javascript: import("http から最後の )); まで全部含めてコピーする必要があります
